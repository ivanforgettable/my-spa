  ...
  return (
    <div>
      ...
      <p className="historical-text">
        ...
        независимо от географического мест��положения. Мы верим, что понимание
      ...
      <div className="historical-contact-card">
        ...
        <ul className="historical-list">
          <li>
            <strong>Профессор Александров В.И.</strong> — доктор исторических
            наук, специалист по древней истории (МГУ)
          </li>
          <li>
            <strong>Доцент Петрова Е.А.</strong> — кандидат наук, эксперт по
      ...
      <div className="historical-contact-card">
        ...
        <ul className="historical-list">
          <li>Более 2000 выпускников за 5 лет работы</li>
          <li>95% студентов успешно сдают ЕГЭ по истории на высокие баллы</li>
          <li>Победители исторических олимпиад среди наших учеников</li>
          <li>Партнерство с ведущими музеями России</li>
          <li>Официальное признание Министерства образования</li>
        </ul>
      </div>
      ...
      <ul className="historical-list">
        <li>HD видеолекции с интерактивными элементами</li>
        <li>Виртуальную реальность для погружения в исторические эпохи</li>
        <li>Онлайн симуляции исторических событий</li>
        <li>Цифровые архивы документов и артефактов</li>
        <li>Систему автоматической проверки знаний</li>
      </ul>
